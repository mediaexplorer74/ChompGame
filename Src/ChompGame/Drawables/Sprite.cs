...
namespace GameManager
{
	public class Sprite
	{
		...
		public void Center()
		{
			Position = new Vector2(((Game1.ScreenWidth - Animation.CurrentFrame.Width)/2.0f) + (Animation.CurrentFrame.Width/2.0f),
									((Game1.ScreenHeight - Animation.CurrentFrame.Height)/2.0f) + (Animation.CurrentFrame.Height/2.0f));
		}
