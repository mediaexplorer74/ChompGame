...
namespace GameManager
{
	...
	public class MonsterSprite : Sprite
	{
		...
		public override void Update(GameTime gameTime)
		{
			...
			DrawBorder = Game1.Instance.DebugMode;
		...
		{
			Position = new Vector2((col * Maze.TileWidth) + Maze.MazeOffset.X + (Maze.TileWidth/2.0f),
				(row * Maze.TileHeight) + (Maze.MazeOffset.Y + Maze.TileHeight/2.0f));
			Row = row;
			Column = col;
		}
