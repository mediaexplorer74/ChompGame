...
namespace GameManager
{
	public class GameScreen : Screen
	{
		...
		public void InitializeLevel(int level)
		{
			...
			_maze = new Maze(Game1.Instance, _currentLevel.Data);
		...
		{
			if(!Game1.Instance.DebugMode && _enemy.CollisionBox.Intersects(_player.CollisionBox))
			{
				if(_numLives == 0)
					GameOver();
				else
